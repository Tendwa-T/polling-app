        ...
        <Paper sx={{ p: '1em', mt: '1em', borderRadius: '2em', maxWidth: '40em', width: '35em' }}>
            ...
            <Box sx={{ display: 'flex', flexGrow: 1 }}>
                <TextField
                    ...
                    onChange={(e) => setDataObj({ ...dataObj, firstName: e.target.value })}
                />
                <Box sx={{ width: '1em' }} />
                <TextField
                    id="LastName"
                    ...
                    onChange={(e) => setDataObj({ ...dataObj, lastName: e.target.value })}
                />
            </Box>
            <TextField
                id="email"
            ...
            <Box>
                ...
                <TextField
                    ...
                    onChange={(e) => setDataObj({ ...dataObj, confirmPassword: e.target.value })}
                    error={!errBod.globalErr && errBod.err}
                    helperText={errBod.globalErr ? "" : errBod.errMsg}
                    slotProps={{
                        input: {
